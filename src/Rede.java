...
public class Rede {
	...
	do {
		...
		System.out.println("Informe os atributos do padrao:");
		...
		System.out.println("Informe a saida desejada do padrao citado anteriormente:");
    ...
    public void testarRede(){
		...
		mcp.setEntradas(i, entrada.nextInt());
            }
            mcp.calculaSaidaNeuronio();
        } while (entrada.nextInt() == 7);
    }
